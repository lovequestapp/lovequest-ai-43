...
const Monetization: React.FC<MonetizationProps> = ({ userData }) => {
  ...
  const calculateEarnings = () => {
    ...
    const receivedGifts = user.receivedGifts || { rose: 0, heart: 0, teddy: 0 };
                  ...
                  <form onSubmit={withdrawalForm.handleSubmit(onSubmitWithdrawal)} className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 mt-2">
                            <Button 
                              ...
                              className={`h-auto py-3 flex flex-col items-center justify-center gap-1 ${
                                field.value === 'bank' ? 'border-love-500' : ''
                              }`}
                              onClick={() => {
                                field.onChange('bank');
                            ...
                            <Button 
                              type="button"
                              variant={field.value === 'paypal' ? 'default' : 'outline'}
                              className={`h-auto py-3 flex flex-col items-center justify-center gap-1 ${
                                field.value === 'paypal' ? 'border-love-500' : ''
                              }`}
                              onClick={() => {
                    ...
                    <div className="pt-4">
                      <Button 
                        ...
                        disabled={!availableBalance || availableBalance < 10}
                      >
